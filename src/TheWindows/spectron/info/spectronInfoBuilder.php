...
final class spectronInfoBuilder{

	public static function create() : self{
		static $counter = 0;
		return new self(
			Uuid::uuid4(),
			(string) mt_rand(2 * (10 ** 15), (3 * (10 ** 15)) - 1),
			"spectron" . ++$counter,
	...
	public function build() : spectronInfo{
		return new spectronInfo($this->uuid, $this->xuid, $this->username, $this->skin, $this->extra_data, $this->behaviours);
	}
}